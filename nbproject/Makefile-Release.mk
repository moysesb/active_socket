...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/active_socket: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/active_socket ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/ActiveTCPClient.o: ActiveTCPClient.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ActiveTCPClient.o ActiveTCPClient.cpp
